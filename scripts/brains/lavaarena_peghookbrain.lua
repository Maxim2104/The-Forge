...
local maxSpitRange = TUNING.LAVAARENA_PEGHOOK.SPITRANGE * TUNING.LAVAARENA_PEGHOOK.SPITRANGE
local minSpitRange = TUNING.LAVAARENA_PEGHOOK.RANGE * TUNING.LAVAARENA_PEGHOOK.RANGE + 4
local SEE_DIST = 30
