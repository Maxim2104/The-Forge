...
local function AreaMobSleep(inst, sleeptimecache, sleepdelaycache, doer)
    ...
    local ents =
        ...
        TheSim:FindEntities(x, y, z, range, nil, { "follower", "playerghost", "smallcreature", "monster", "hostile", "animal", "pig", "largecreature", "tentacle_pillar", "walrus" }, { "sleeper", "player" }) or
...
local function oncastfn(inst, doer, pos)
	inst._sleeptask = inst:DoPeriodicTask(0.5, function(inst)
		AreaMobSleep(inst, doer, pos)
	end)
