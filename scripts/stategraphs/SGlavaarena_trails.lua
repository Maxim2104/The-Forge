...
local slamRecharge = TUNING.LAVAARENA_TRAILS.SLAM_RECHARGE
...
local states=
{
	...
	State{
        ...
        onenter = function(inst)
			inst.components.health:SetAbsorptionAmount(TUNING.LAVAARENA_TRAILS.SHIELDED_DAMAGE_REDUCTION)
			inst.Physics:Stop()
...
return StateGraph("lavaarena_boaron", states, events, "taunt", actionhandlers)
